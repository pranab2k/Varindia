...
export default class CSRInitiatives extends Component {
    constructor(props) {        
        super(props);
        this.state = {
          isLoading: true,  
        ...
        componentDidMount() {
            ...
            fetch('https://varindia.com/varindiaapp/api/newslisting.php/?results=20&cat=631&posttype=news&page=' + this.page)
    ...
    return (
      <Container>
        ...
        <Icon name="angle-left" size={30} color="#000000" />
          ...
          <Body>
          <Title style={styles.title}>CSR Initiatives</Title>
          </Body>
        </Header>
