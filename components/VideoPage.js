...
export default class VideoPage extends Component {
    constructor(props) {        
        ...
        componentDidMount() {
            ...
            fetch('https://varindia.com/varindiaapp/api/newslisting.php/?results=20&cat=627&posttype=video&page=' + this.page)
      ...
      GetNews(news_id){
       ...
       // Alert.alert(news_id);
        this.props.navigation.navigate('S11',{newsId:news_id});
        }
    ...
    return (
      <Container>
        ...
        <Icon name="angle-left" size={30} color="#000000" />
          ...
          <Body>
          <Title style={styles.title}>Video</Title>
          </Body>
        </Header>
