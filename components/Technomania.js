...
export default class Technomania extends Component {
    constructor(props) {        
        super(props);
        this.state = {
          isLoading: true,  
        ...
        componentDidMount() {
            ...
            fetch('https://varindia.com/varindiaapp/api/newslisting.php/?results=20&cat=625&posttype=news&page=' + this.page)
    ...
    return (
      <Container>
        ...
        <Icon name="angle-left" size={30} color="#000000" />
          ...
          <Body>
          <Title style={styles.title}>Technomania</Title>
          </Body>
        </Header>
