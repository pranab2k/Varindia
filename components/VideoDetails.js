...
export default class NewsDetails extends Component {
    ...
    //  alert('pp');
      return fetch('https://varindia.com/varindiaapp/api/videodetails.php?newsid='+newsid)
    ...
    Share = async () => {
      try {
        const result = await Share.share({
          message: this.state.dataSourceTitle+" https://varindia.com/video/"+this.state.dataSourceSlug,
          title: "Varindia App",
          url:"https://varindia.com/video/"+this.state.dataSourceSlug
        });
    ...
    return (
      <Container>
        ...
        <Button transparent onPress={() => this.props.navigation.goBack()}>        
          ...
          <Body>
          <Title style={{color:'#000', textAlign: "left"}}>Video</Title>
          </Body>
        </Header>
        ...
        <View style={{ height: imageheight }}>
            ...
            <WebView
                    ...
                    source={{uri: 'https://www.youtube.com/embed/'+this.state.dataSourceDesc}}
