...
export default class MoversShakers extends Component {
    constructor(props) {        
        super(props);
        this.state = {
          isLoading: true,  
        ...
        componentDidMount() {
            ...
            fetch('https://varindia.com/varindiaapp/api/newslisting.php/?results=20&cat=621&posttype=news&page=' + this.page)
    ...
    return (
      <Container>
        ...
        <Icon name="angle-left" size={30} color="#000000" />
          ...
          <Body>
          <Title style={styles.title}>Movers & Shakers</Title>
          </Body>
        </Header>
